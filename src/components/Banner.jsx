              ...
              <div className="pt-5 mt-5 pt-lg-0 mt-lg-0 row align-items-center justify-content-center text-center text-lg-start vh-80">
                  <div className="col-lg-7">
                      ...
                      <form action="" className="mb-sm-4 d-flex flex-wrap mx-auto align-items-center justify-content-center">
                          ...
                          <Link to={data ? "/search" : "/"} state={{data : data}}><input type="submit" name="submit" id="submit" className=" mb-sm-0 mb-3 btn text-white bg-color-2 py-3 px-5" value="Search" /></Link>
                      </form>
                      <h5 className="text-white mt-2 d-lg-flex align-items-center">Popular : 
                          {/* <Link to="/all_types" state={{data : 'Book Cover'}} className="text-white px-3 ms-3 btn border-white br-3">Web Design</Link> */}
                          <div className='pt-lg-0 pt-3 ps-lg-3'>
                            <Link to='/all_types?type=Wordpress'><span className="text-white px-3 btn ms-sm-3 ms-0 border-white br-3">Wordpress</span></Link>
                            <Link to='/all_types?type=Logo Design'><span className="text-white px-3 btn ms-sm-3 ms-0 border-white br-3">Logo Design</span></Link>
                            <Link to='/all_types?type=AI Artist'><span className="text-white px-3 btn ms-sm-3 ms-0 border-white br-3">AI Services</span></Link>
                          </div>
                      </h5>
                  </div>
