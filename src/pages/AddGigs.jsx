                        ...
                        <div className="col-md-6">
                            <div className="gig-inner">
                                <div className="mb-4">
                                    ...
                                    <input type="text" name="title" id="title" placeholder="Title" className="form-control py-2 px-3" onChange={formEvent}/>
                                </div>
                                <div className="mb-4">
                                    <label className="mb-3">Category</label>
                                    <select name="cat" id="cat" className="py-2 px-3 input-border w-100 form-control" onChange={formEvent} >
                                ...
                                <div className="mb-4">
                                    ...
                                    <input type="number" name="price" id="price" className="form-control py-2 px-3" min="1" max="999" placeholder='$ 100' onChange={formEvent}/>
                                </div>  
                                <div>
                                    <label className="mb-3">Description</label>
                                    <textarea name="desc" id="desc" className="form-control" placeholder="Description to introduce your services to customers" style={{height: "160px"}} onChange={formEvent}></textarea>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="mb-4">
                                ...
                                <input type="text" name="shortTitle" id="shortTitle" className="form-control py-2 px-3" placeholder="e.g. One page web application" onChange={formEvent}/>
                            </div>
                            <div className="mb-4">
                                <label className="mb-3">Short Description</label>
                                <input type="text" name="shortDesc" id="shortDesc" className="form-control py-2 px-3" placeholder="Short description of your services" onChange={formEvent}/>
                            </div>
                            <div className="mb-4">
                                <label className="mb-3">Delivery Time</label>
                                <input type="number" name="deliveryTime" id="deliveryTime" className="form-control py-2 px-3" placeholder="e.g. 3 days" onChange={formEvent}/>
                            </div>
                            <div className="mb-4">
                                <label className="mb-3">Revision Number</label>
                                <input type="number" name="revisionNumber" id="revisionNumber" className="form-control py-2 px-3" placeholder='e.g. 3' onChange={formEvent}/>
                            </div>
                            <div className="mb-4">
